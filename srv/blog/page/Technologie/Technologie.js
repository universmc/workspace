...
async function main() {
    ...
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "assistant",
                content: "/dev code source HTML de la page d'index du blog dédié aux nouvelles technologie dans le cadre de l'evolution de L'intelligence artificielle et aux techniques d'apprentissage automatique"
            },

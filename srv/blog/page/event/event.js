...
async function main() {
    ...
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "assistant",
                content: "/dev code source HTML de la page d'index du blog dédié à la gestion d'evenement dans le cadre de l'evolution de L'intelligence artificielle et aux techniques d'apprentissage automatique"
            },
        ...
        const outputFilePath = "output/cinéma_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".html";

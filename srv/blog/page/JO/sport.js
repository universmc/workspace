...
async function main() {
    ...
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "assistant",
                content: "/dev code source HTML de la page d'index du blog dédié aux sport, Pour les jeux olympiques, Paris 2024"
            },
        ...
        const outputFilePath = "blogSport_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".html";

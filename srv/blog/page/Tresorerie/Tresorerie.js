...
async function main() {
    ...
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "assistant",
                content: "/dev code source HTML de la page d'index du blog dédié à la Trésorerie, la comptabilité dans le cadre des nouvelles technologie dans et de l'evolution de L'intelligence artificielle et aux techniques d'apprentissage automatique"
            },
        ...
        const outputFilePath = "output/blogTechno_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".html";

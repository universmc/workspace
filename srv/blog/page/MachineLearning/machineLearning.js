...
async function main() {
    ...
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "assistant",
                content: "/dev code source HTML de la page d'index du blog dédié à la machine Learning et aux techniques d'apprentissage automatique"
            },
        ...
        const outputFilePath = "output/MachineLearning_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".html";

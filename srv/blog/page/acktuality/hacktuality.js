...
async function main() {
    ...
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "assistant",
                content: "/dev code source HTML de la page d'index du blog dédié à l'actualité Politique dans le cadre de l'evolution de L'intelligence artificielle et aux techniques d'apprentissage automatique"
            },
        ...
        const outputFilePath = "output/actuality_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".html";

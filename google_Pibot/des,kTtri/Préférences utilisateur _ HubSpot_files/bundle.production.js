...
o.p="//static.hsappstatic.net/head-dlb/static-1.694/"
...
this._handleStackInfo(i,t)}catch(t){if(e!==t)throw t}return this},captureMessage:function(e,t){if(!this._globalOptions.ignoreErrors.test||!this._globalOptions.ignoreErrors.test(e)){var r,n=v({message:e+""},t=t||{})
try{throw new Error(e)}catch(e){r=e}r.name=null
var o=a.computeStackTrace(r),i=o.stack[1],s=i&&i.url||""
if((!this._globalOptions.ignoreUrls.test||!this._globalOptions.ignoreUrls.test(s))&&(!this._globalOptions.whitelistUrls.test||this._globalOptions.whitelistUrls.test(s))){if(this._globalOptions.stacktrace||t&&t.stacktrace){t=v({fingerprint:e,trimHeadFrames:(t.trimHeadFrames||0)+1},t)
var l=this._prepareFrames(o,t)
n.stacktrace={frames:l.reverse()}}this._send(n)
return this}}},captureBreadcrumb:function(e){var t=v({timestamp:D()/1e3},e)
...
this._logDebug("error","Error: Raven has not been configured.")}return!1}return!0},afterLoad:function(){var e=P.RavenConfig
...
l.async=!0
l.src=i+"/api/embed/error-page/"+o;(U.head||U.body).appendChild(l)}},_ignoreNextOnError:function(){var e=this
...
C(o,"removeEventListener",(function(e){return function(t,r,n,o){try{r=r&&(r.__raven_wrapper__?r.__raven_wrapper__:r)}catch(e){}return e.call(this,t,r,n,o)}}),t)}}C(P,"setTimeout",r,t)
C(P,"setInterval",r,t)
P.requestAnimationFrame&&C(P,"requestAnimationFrame",(function(t){return function(r){return t(e.wrap(r))}}),t)
...
function n(t,r){t in r&&p(r[t])&&C(r,t,(function(t){return e.wrap(t)}))}if(t.xhr&&"XMLHttpRequest"in P){var o=XMLHttpRequest.prototype
...
return t.apply(this,arguments)}}),r)}t.xhr&&"fetch"in P&&C(P,"fetch",(function(t){return function(r,n){for(var o=new Array(arguments.length),a=0;a<o.length;++a)o[a]=arguments[a]
var i,s=o[0],l="GET"
...
C(history,"replaceState",l,r)}if(t.console&&"console"in P&&console.log){var u=function(t,r){e.captureBreadcrumb({message:t,level:r.level,category:"console"})}
...
this._hasNavigator&&I.userAgent&&(e.headers={"User-Agent":navigator.userAgent})
...
this._backoffStart=null},_shouldBackoff:function(){return this._backoffDuration&&D()-this._backoffStart<this._backoffDuration},_isRepeatData:function(e){var t=this._lastData
...
this._backoffStart=D()}}},_send:function(e){var t=this._globalOptions,r={project:this._globalProject,logger:t.logger,platform:"javascript"},n=this._getHttpData()
n&&(r.request=n)
...
e.extra["session:duration"]=D()-this._startTime
...
e&&!g(e)&&(p(t.shouldSendCallback)&&!t.shouldSendCallback(e)||(this._shouldBackoff()?this._logDebug("warn","Raven dropped error due to backoff: ",e):"number"==typeof t.sampleRate?Math.random()<t.sampleRate&&this._sendProcessedPayload(e):this._sendProcessedPayload(e)))},_getUuid:function(){return E()},_sendProcessedPayload:function(e,t){var r=this,n=this._globalOptions
...
r.request=t
e.onError(r)})}t.open("POST",r+"?"+x(e.auth))
...
e=e.values[0]
t=t.values[0]
return e.type===t.type&&e.value===t.value&&E(e.stacktrace,t.stacktrace)}function E(e,t){if(w(e,t))return!1
...
Object.defineProperty(t,"__esModule",{value:!0})
t.default=f
var o=n(r(16)),a=n(r(17)),i=n(r(5)),s=n(r(13))
const l=2e5
...
s.default._newRelicCallbacks.push(()=>{window.newrelic.setCustomAttribute&&window.newrelic.setCustomAttribute("ravenMissingTags",!0)})}const{bender:r}=s.default,n={sampleRate:1,stacktrace:!1,ignoreErrors:["Aborting: redirection in progress",/Aborting: notifying parents of unauthorized response/,/Cannot set property 'install' of undefined/,/ResizeObserver loop completed with undelivered notifications/,/ResizeObserver loop limit exceeded/,/'URLSearchParams' is not defined/,/Not implemented on this platform/],ignoreUrls:[]},l=t.ignoreErrors||[]
u((t=Object.assign({},n,t,{ignoreErrors:[...n.ignoreErrors,...l]})).ignoreErrors)
const f=o.default.getShort("sentry")
let d
try{d=!!(document&&document.cookie&&document.cookie.includes("hs_selenium"))}catch(e){d=!1}i.default.config(e,{release:r&&r.currentProjectVersion,ignoreErrors:t.ignoreErrors,ignoreUrls:t.ignoreUrls,sampleRate:t.sampleRate,environment:f,tags:Object.assign({env:f,project:r&&r.currentProject,portalId:a.default.get(),hublet:o.default.getHublet(),isAcceptanceTest:d},t.tags),breadcrumbCallback:t.breadcrumbCallback||(e=>e),autoBreadcrumbs:{console:!1},dataCallback:c(t.dataCallback),shouldSendCallback:t.shouldSendCallback||(()=>!0),stacktrace:t.stacktrace}).install()
...
Object.defineProperty(t,"__esModule",{value:!0})
t.default=void 0
const n=["api","local","app","private","platform","tools","meetings"],o=["hubspotstarter","hubspotfree"],a=["growth"],i=["hubspot"],s={com:["hubspot","hubteam","grader","getsignals","getsidekick","gettally","hubspotemail","customer-hub","hubspotservicehub","hubspotquote"].join("|"),net:o.join("|"),org:a.join("|"),dev:i.join("|")},l=function e(t){const r=new RegExp(`^(?!local|test|selenium)(.*\\.)?(${Object.entries(s).map(([e,t])=>`(?:${t})(qa)?\\.${e}`).join("|")}|(?:connect)\\.com|(?:connect)(qa)\\.co|wthubspot\\.com)$`).test(t.hostname),o=new RegExp(Object.entries(s).map(([e,t])=>`(?:${t})qa\\.${e}`).join("|")+"|(?:connect)qa\\.co|wthubspot\\.com"),a=new RegExp(`^(?:${n.join("|")})-(.*).(?:hubspot|hubteam)(?:qa)?.com`),i=new RegExp("^(.*).(?:hubspotquote)(?:qa)?.com"),l="ENV",u="Enviro error: the default argument for .get and .getShort is no longer supported",c=e=>{let t=window[e]
...
return e||(a.test(t.hostname)?a.exec(t.hostname)[1]:i.test(t.hostname)?i.exec(t.hostname)[1]:"na1")},getInternal:v,getShort:m,isProd:_,isQa:y,normalize:h,set:function(e,t){if(1===arguments.length){t=e
...
//# sourceMappingURL=//static.hsappstatic.net/head-dlb/static-1.694/bundle.production.js.map